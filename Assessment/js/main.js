...
/*************************************************************************************
------------ ANSWER -------------------
x will log "I'm a local variable" to the console.  It is a local variable to the IIFE function.
y will not log to console, it is a local variable nested within the function scopeThis().
**************************************************************************************/
...
/*************************************************************************************
------------ ANSWER -------------------
x will be undefined, the variable declaration will be hoisted, but the string it is assigned to will not be.
Also, foo() will run and return "function hoisting"
**************************************************************************************/
...
------------ ANSWER -------------------
Inside IFEE: log 4.
Outside IFEE: Undefined.
var add is a local variable contained within the function.
**************************************************************************************/
